<#
REFERENCE:
Users: https://docs.microsoft.com/en-us/graph/api/user-list?view=graph-rest-1.0
DirectoryRoles:  https://docs.microsoft.com/en-us/graph/api/directoryrole-get?view=graph-rest-1.0
    ...
    if ($DirectoryRoles) {
        ...
        foreach ($role in $DirectoryRoles) {
            ...
            foreach ($member in $RoleMembers) {
                ...
                $CheckMemberResult += $guestUsers | Where-Object -FilterScript {$_.userPrincipalName -eq $member.userPrincipalName}
